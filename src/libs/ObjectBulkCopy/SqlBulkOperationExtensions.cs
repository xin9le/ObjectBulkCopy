...
public static class SqlBulkOperationExtensions
{
    ...
    /// <returns></returns>
    public static async ValueTask<int> BulkInsertAsync<T>(this SqlConnection connection, IEnumerable<T> data, SqlBulkCopyOptions options, int? timeout, CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    /// <typeparam name="T">The type of the data to be inserted.</typeparam>
    /// <param name="transaction">The <see cref="SqlTransaction"/> to use for the bulk insert operation.</param>
    /// <param name="data">The data to be inserted.</param>
    /// <param name="options">The <see cref="SqlBulkCopyOptions"/> to use for the bulk insert operation.</param>
    /// <param name="timeout">The timeout for the bulk insert operation, in seconds. If <c>null</c>, the default timeout is used.</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe while waiting for the task to complete.</param>
    /// <returns>A ValueTask representing the asynchronous operation, with the number of rows copied as the result.</returns>
    public static async ValueTask<int> BulkInsertAsync<T>(this SqlTransaction transaction, IEnumerable<T> data, SqlBulkCopyOptions options, int? timeout, CancellationToken cancellationToken = default)
    {
